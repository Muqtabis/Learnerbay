        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              Fill out the form below and I will analyze your preferences to recommend the best courses for you.
            </p>
          </div>
          ...
          <div className="mt-16 bg-white p-6 md:p-8 rounded-lg shadow-md">
            ...
            <p className="text-slate-600 mb-4">
              Our course recommendation system uses filters to analyze several factors:
            </p>
